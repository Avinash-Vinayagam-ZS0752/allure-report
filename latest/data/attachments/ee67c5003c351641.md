...
- generic [active]:
  - main:
    ...
    - generic [ref=e65]:
      - img "Second slide" [ref=e67]
      - img "Third slide" [ref=e69]
    - generic [ref=e70]:
      - heading "© Congruent Solutions, Inc. All Rights Reserved" [level=1] [ref=e72]
      - heading "Privacy Policy" [level=1] [ref=e75] [cursor=pointer]
      - img "logo" [ref=e78]
```
